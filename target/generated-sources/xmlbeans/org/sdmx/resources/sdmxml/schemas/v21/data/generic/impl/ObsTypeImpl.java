 ...
 */
public class ObsTypeImpl extends org.sdmx.resources.sdmxml.schemas.v21.common.impl.AnnotableTypeImpl implements org.sdmx.resources.sdmxml.schemas.v21.data.generic.ObsType
{
    ...
    private static final javax.xml.namespace.QName OBSDIMENSION$0 = 
        new javax.xml.namespace.QName("http://www.sdmx.org/resources/sdmxml/schemas/v2_1/data/generic", "ObsDimension");
     ...
     */
    public org.sdmx.resources.sdmxml.schemas.v21.data.generic.BaseValueType getObsDimension()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.sdmx.resources.sdmxml.schemas.v21.data.generic.BaseValueType target = null;
            target = (org.sdmx.resources.sdmxml.schemas.v21.data.generic.BaseValueType)get_store().find_element_user(OBSDIMENSION$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setObsDimension(org.sdmx.resources.sdmxml.schemas.v21.data.generic.BaseValueType obsDimension)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.sdmx.resources.sdmxml.schemas.v21.data.generic.BaseValueType)get_store().add_element_user(OBSDIMENSION$0);
            }
            target.set(obsDimension);
        }
    }
     ...
     */
    public org.sdmx.resources.sdmxml.schemas.v21.data.generic.BaseValueType addNewObsDimension()
    {
        synchronized (monitor())
        {
            check_orphaned();
