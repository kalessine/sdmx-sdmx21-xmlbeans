 ...
 */
public class MetadataSetTypeImpl extends org.sdmx.resources.sdmxml.schemas.v21.common.impl.AnnotableTypeImpl implements org.sdmx.resources.sdmxml.schemas.v21.metadata.generic.MetadataSetType
{
    ...
    private static final javax.xml.namespace.QName DATAPROVIDER$2 = 
        new javax.xml.namespace.QName("http://www.sdmx.org/resources/sdmxml/schemas/v2_1/metadata/generic", "DataProvider");
    private static final javax.xml.namespace.QName REPORT$4 = 
        new javax.xml.namespace.QName("http://www.sdmx.org/resources/sdmxml/schemas/v2_1/metadata/generic", "Report");
     ...
     */
    public org.sdmx.resources.sdmxml.schemas.v21.metadata.generic.ReportType[] getReportArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            org.sdmx.resources.sdmxml.schemas.v21.metadata.generic.ReportType[] result = new org.sdmx.resources.sdmxml.schemas.v21.metadata.generic.ReportType[targetList.size()];
            targetList.toArray(result);
            return result;
        }
    }
     ...
     */
    public org.sdmx.resources.sdmxml.schemas.v21.metadata.generic.ReportType getReportArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.sdmx.resources.sdmxml.schemas.v21.metadata.generic.ReportType target = null;
            target = (org.sdmx.resources.sdmxml.schemas.v21.metadata.generic.ReportType)get_store().find_element_user(REPORT$4, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
     ...
     */
    public void setReportArray(org.sdmx.resources.sdmxml.schemas.v21.metadata.generic.ReportType[] reportArray)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void setReportArray(int i, org.sdmx.resources.sdmxml.schemas.v21.metadata.generic.ReportType report)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public org.sdmx.resources.sdmxml.schemas.v21.metadata.generic.ReportType insertNewReport(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.sdmx.resources.sdmxml.schemas.v21.metadata.generic.ReportType target = null;
            target = (org.sdmx.resources.sdmxml.schemas.v21.metadata.generic.ReportType)get_store().insert_element_user(REPORT$4, i);
            return target;
        }
    }
     ...
     */
    public org.sdmx.resources.sdmxml.schemas.v21.metadata.generic.ReportType addNewReport()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.sdmx.resources.sdmxml.schemas.v21.metadata.generic.ReportType target = null;
            target = (org.sdmx.resources.sdmxml.schemas.v21.metadata.generic.ReportType)get_store().add_element_user(REPORT$4);
            return target;
        }
    }
