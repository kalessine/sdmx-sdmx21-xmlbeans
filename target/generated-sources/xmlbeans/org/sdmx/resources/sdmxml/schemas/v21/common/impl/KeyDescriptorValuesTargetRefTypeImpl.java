 ...
 */
public class KeyDescriptorValuesTargetRefTypeImpl extends org.sdmx.resources.sdmxml.schemas.v21.common.impl.ComponentRefBaseTypeImpl implements org.sdmx.resources.sdmxml.schemas.v21.common.KeyDescriptorValuesTargetRefType
{
    private static final long serialVersionUID = 1L;
    
    public KeyDescriptorValuesTargetRefTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public org.sdmx.resources.sdmxml.schemas.v21.common.NestedIDType xgetId()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.sdmx.resources.sdmxml.schemas.v21.common.NestedIDType target = null;
            target = (org.sdmx.resources.sdmxml.schemas.v21.common.NestedIDType)get_store().find_attribute_user(ID$2);
            if (target == null)
            {
                target = (org.sdmx.resources.sdmxml.schemas.v21.common.NestedIDType)get_default_attribute_value(ID$2);
            }
            return target;
        }
    }
    ...
    public void xsetId(org.sdmx.resources.sdmxml.schemas.v21.common.NestedIDType id)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.sdmx.resources.sdmxml.schemas.v21.common.NestedIDType)get_store().add_attribute_user(ID$2);
            }
            target.set(id);
        }
    }
    ...
    public org.sdmx.resources.sdmxml.schemas.v21.common.ObjectTypeCodelistType.Enum getClass1()
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_default_attribute_value(CLASS1$4);
            }
            if (target == null)
            {
                return null;
    ...
    public org.sdmx.resources.sdmxml.schemas.v21.common.ObjectTypeCodelistType xgetClass1()
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.sdmx.resources.sdmxml.schemas.v21.common.ObjectTypeCodelistType)get_default_attribute_value(CLASS1$4);
            }
            return target;
        }
    }
    ...
    public org.sdmx.resources.sdmxml.schemas.v21.common.PackageTypeCodelistType.Enum getPackage()
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_default_attribute_value(PACKAGE$6);
            }
            if (target == null)
            {
                return null;
    ...
    public org.sdmx.resources.sdmxml.schemas.v21.common.PackageTypeCodelistType xgetPackage()
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.sdmx.resources.sdmxml.schemas.v21.common.PackageTypeCodelistType)get_default_attribute_value(PACKAGE$6);
            }
            return target;
        }
    }
