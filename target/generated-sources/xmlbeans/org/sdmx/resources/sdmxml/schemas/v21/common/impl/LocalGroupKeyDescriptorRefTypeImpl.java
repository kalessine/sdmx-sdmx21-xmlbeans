 ...
 */
public class LocalGroupKeyDescriptorRefTypeImpl extends org.sdmx.resources.sdmxml.schemas.v21.common.impl.LocalComponentListRefBaseTypeImpl implements org.sdmx.resources.sdmxml.schemas.v21.common.LocalGroupKeyDescriptorRefType
{
    private static final long serialVersionUID = 1L;
    
    public LocalGroupKeyDescriptorRefTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public org.sdmx.resources.sdmxml.schemas.v21.common.ObjectTypeCodelistType.Enum getClass1()
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_default_attribute_value(CLASS1$0);
            }
            if (target == null)
            {
                return null;
    ...
    public org.sdmx.resources.sdmxml.schemas.v21.common.ObjectTypeCodelistType xgetClass1()
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.sdmx.resources.sdmxml.schemas.v21.common.ObjectTypeCodelistType)get_default_attribute_value(CLASS1$0);
            }
            return target;
        }
    }
